import {ACCESS_KEY_SECRET,ACCESS_KEY_ID } from './config/index'
let OSS = require('ali-oss')
const path = require('path')
const mime = require('mime')
const fs = require('fs')
const BUCKEY = 'lecheng-static'
...
async function uploadFile (ossPath ,filePath , uploadOptions, callback) {
  try {
    const result = await client.put(filePath, ossPath, uploadOptions)
    // console.log(result.res.requestUrls,'==',Object.keys(result))
    console.log(filePath, ossPath, uploadOptions)
