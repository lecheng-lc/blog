<template>
  <div class="dash-box">
    ...
    <div class="dash-content message-pannel">
      <div v-if="props.messages && props.messages.length > 0">
        <div class="direct-chat-msg" v-for="msg in props.messages" :key="msg._id">
          <div class="direct-chat-info clearfix">
            <span class="direct-chat-name pull-left">
              ...
              <a href="#">{{ msg.utype == '1' ? (msg.replyAuthor ? msg.replyAuthor.userName : (msg.adminReplyAuthor ?
                msg.adminReplyAuthor.userName : '')) : '' }}</a>
            </span>
          ...
          <RandomLogo :user="msg.author ? msg.author : msg.adminAuthor" />
